...
export default function SubscriptionCard({ id, name, price, durationInMonths, features, isPremium, onSelectSubscription }) {
  return (
    <>
        {/* Basic  */}
        {!isPremium && (
            <div
                ...
                <div>
                    ...
                    <p className="text-gray-1 text-xs font-light">/{durationInMonths} months</p>
                </div>
        ...
        {isPremium && (
            <div
                ...
                <div>
                    ...
                    <p className="text-[#767676] text-xs font-light">/{durationInMonths} months</p>
                </div>
